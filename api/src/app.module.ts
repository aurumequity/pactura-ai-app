...
@Module({
  ...
  imports: [FirebaseModule, WhoAmIModule, OrgsModule, DocumentsModule, GapCheckModule, AuditSummaryModule, AnomalyDetectModule, RemediationsModule, AuditLogsModule],
